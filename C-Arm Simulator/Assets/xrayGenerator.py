...
def save_xray_to_text(xray_image, file_name):
    ...
    # save_random_data_test("save_xray_to_text_TEST")
...
def save_random_data_test(filename):
    data = np.random.random((5, 3))  # A 5x3 array of random numbers between 0 and 1
    np.savetxt('C:/Users/mdigr/4450_Capstone_AR_C-Arm_Sim/C-Arm Simulator/Assets/' + filename, data, fmt='%.2f',
               delimiter='\t')


def save_example_png_test():
...
output_text_file = 'C:/Users/mdigr/4450_Capstone_AR_C-Arm_Sim/C-Arm Simulator/Assets/output_3d_array.txt'
save_3d_array_to_text(image_data, output_text_file)


def main():
    # save_random_data_test("main_TEST")
    ...
    text_file_path = "C:/Users/mdigr/4450_Capstone_AR_C-Arm_Sim/C-Arm Simulator/Assets/output_3d_array.txt"
    voxel_array = read_3d_array_from_text(output_text_file)
    ...
    save_example_png_test()

    # Save the circular-shaped X-ray as text and PNG
    save_xray_to_text(circular_xray_image, 'C:/Users/mdigr/4450_Capstone_AR_C-Arm_Sim/C-Arm Simulator/Assets/xray.txt')
    save_xray_to_png(circular_xray_image, 'C:/Users/mdigr/4450_Capstone_AR_C-Arm_Sim/C-Arm Simulator/Assets/xray.png')
